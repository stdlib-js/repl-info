...
```javascript
info = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-info@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/repl-info/tags). For example,

```javascript
info = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-info@v0.4.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var info = require( 'path/to/vendor/umd/repl-info/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/repl-info@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/repl-info/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/repl-info/actions/workflows/test.yml?query=branch:v0.4.1
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/repl-info.svg
[dependencies-url]: https://david-dm.org/stdlib-js/repl-info/main
...
[cli-section]: https://github.com/stdlib-js/repl-info#cli
[cli-url]: https://github.com/stdlib-js/repl-info/tree/cli
[@stdlib/repl-info]: https://github.com/stdlib-js/repl-info/tree/main
