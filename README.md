...
```javascript
info = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-info@v0.3.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/repl-info/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/repl-info/actions/workflows/test.yml?query=branch:v0.3.0
